        ...
        <div className="header-body-section">
          <nav className="nav">
            <div class="container container-nav">
              ...
              <ul>
                <li>
                  <a href="investor">Invester Relations</a>
                </li>
                <li>
          ...
          <div class="header-body-content">
            <div class="container container-header-body">
              ...
              />
              <p class="header-body-section-discover">
                Discover the best food & drinks in Mumbai
              </p>
              <div class="search-container">
                <div class="detectionlocation">
                  <i class="fa-sharp fa-solid fa-location-dot location-map"></i>
                  <input type="text" placeholder="Mumbai" />
                  <i class="fa-sharp fa-solid fa-caret-down caret-up"></i>
                </div>
                <div class="line">| </div>
